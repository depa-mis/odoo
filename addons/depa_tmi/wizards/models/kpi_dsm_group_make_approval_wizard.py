...
class kpi_dsm_group_make_approval_wizard(models.TransientModel):
    ...
    def action_approve(self):
        ...
        if setting_dsm_id.approve_count < approval_lines_count:
            ...
            self.kpi_setting_dsm_group_id.message_post(body="ขออนุมัติ KPI(กลุ่มงาน) เสร็จสิ้น")
    ...
    def action_reject(self):
        ...
        self.kpi_setting_dsm_group_id.message_post(body="ขออนุมัติ KPI(กลุ่มงาน) ปรับแก้ไข")