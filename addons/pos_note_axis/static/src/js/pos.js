odoo.define('pos_note_axis.addnote', function (require) {
"use strict";
...
var QWeb = core.qweb;
    ...
    screens.define_action_button({
        ...
        'condition': function(){
            return this.pos.config.pos_enable_product_note;
        },
    });
    ...
    models.Orderline = models.Orderline.extend({
        ...
        export_for_printing: function() {
            var self = this;
            self.pos.product_note = self.pos.config.is_pos_product_note_receipt;
    ...
    models.Order = models.Order.extend({
        ...
        export_for_printing: function(){
            var self = this;
            self.pos.order_note = self.pos.config.is_pos_order_note_receipt;
    ...
    screens.PaymentScreenWidget.include({
        show: function() {
            self = this;
            this._super();
            $("textarea#order_note").focusin(function() {
        ...
        validate_order: function(force_validation) {
            if(this.pos.config.pos_enable_order_note) {
