...
class CancelInvoiceWizard(models.TransientModel):
    ...
    invoice_ids = fields.Many2many('account.invoice','account_inv_cancel_invoice_wizard','invoice_id','wizard_id', string='Invoice')
    ...
    def cancel_selected_invoice_orders(self):
        ...
        if self.invoice_ids:
           self.invoice_ids.with_context({'Flag':True}).action_cancel()
