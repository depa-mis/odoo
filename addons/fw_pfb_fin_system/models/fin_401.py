...
class fw_pfb_FS401(models.Model):
    ...
    def _onchange_activity_period(self):
        ...
        if self.activity_end_date:
            self.fin_end_date = self.date_by_adding_business_days(datetime.strptime(self.activity_end_date, '%Y-%m-%d').date(), day_count)
    ...
    def create(self, vals):
        ...
        return super(fw_pfb_FS401, self).create(vals)
