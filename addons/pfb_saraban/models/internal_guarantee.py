...
class internalDocumentGuarantee(models.Model):
    _name = 'document.internal.guarantee'
    _description = 'สารบรรณ หนังสือภายใน หนังสือรับรอง'
    ...
    setting_line_ids = fields.One2many('document.internal.gurantee.setting.line','setting_id', string='Document main line')
...
class  InternalDocumentguranteeSettingLine(models.Model):
    _name = 'document.internal.gurantee.setting.line'
    _order='status,sequence,id'

    setting_id = fields.Many2one('document.internal.gurantee', string="document gurantee")
