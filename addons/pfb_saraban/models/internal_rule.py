...
class internalDocumentRule(models.Model):
    _name = 'document.internal.rule'
...
class  InternalDocumentruleSettingLine(models.Model):
    _name = 'document.internal.rule.setting.line'
    _order='status,sequence,id'

    setting_id = fields.Many2one('document.internal.rule', string="document rule")
