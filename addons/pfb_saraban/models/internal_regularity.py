...
class internalDocumentRegularity(models.Model):
    _name = 'document.internal.regularity'
    _description = 'สารบรรณ หนังสือภายใน ระเบียบ'
    ...
    setting_line_ids = fields.One2many('document.internal.regularity.setting.line','setting_id', string='Document main line')
...
class  InternalDocumentRegularitySettingLine(models.Model):
    _name = 'document.internal.regularity.setting.line'
    _order='status,sequence,id'

    setting_id = fields.Many2one('document.internal.regularity', string="document regularity")
