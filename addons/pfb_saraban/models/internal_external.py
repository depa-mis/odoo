...
class internalDocumentExternal(models.Model):
    _name = 'document.internal.external'
    _description = 'สารบรรณ หนังสือภายใน หนังสือภายนอก'
    ...
    dear=fields.Selection([
        ...
        ('job_name', 'Job position')], string="Dear", default='empolyee_name', required=True)
    ...
    setting_line_ids = fields.One2many('document.internal.external.setting.line','setting_id', string='Document main line')
...
class  InternalDocumentexternalSettingLine(models.Model):
    _name = 'document.internal.external.setting.line'
    _order='status,sequence,id'

    setting_id = fields.Many2one('document.internal.external', string="document external")
