...
class internalDocumentOrder(models.Model):
    _name = 'document.internal.order'
    _description = 'สารบรรณ หนังสือภายใน คำสั้ง'
    ...
    setting_line_ids = fields.One2many('document.internal.order.setting.line','setting_id', string='Document main line')
...
class  InternalDocumentorderSettingLine(models.Model):
    _name = 'document.internal.order.setting.line'
    _order='status,sequence,id'

    setting_id = fields.Many2one('document.internal.order', string="document order")
