...
from docx.shared import Pt, Mm, Inches, Length
...
class WordWizardReportInherit(models.TransientModel):
    _inherit = 'word.wizard.report'
    ...
    def from_data(self, current_id):
        ...
        for doc_ids in rec_ids:
            if doc_ids.document_type == 'บันทึกข้อความ':
                ...
                for employee_name in doc_ids.setting_line_ids_related:
                    if employee_name.is_active:
                        ...
                        job_em.append(str(employee_name.employee_id.job_id.name))
                ...
                sevenso_record = document.add_paragraph('จึงมาเรียน')
                sevenso_record.add_run(for_document)
                sevenso_record.paragraph_format.line_spacing_rule = WD_LINE_SPACING.SINGLE
                sevenso_record.paragraph_format.left_indent = Inches(0.9842520)
                sevenso_record.paragraph_format.space_after = Pt(0)
                sevenso_record.paragraph_format.space_before = Pt(6)
                ...
                sevens_record.paragraph_format.space_before = Pt(0)
                ...
                eight_record.paragraph_format.left_indent = Inches(3.188976)
                eight_record.paragraph_format.space_after = Pt(0)
                eight_record.paragraph_format.space_before = Pt(0)
            ...
            if doc_ids.document_type == 'ประกาศ':
                ...
                font1 = one_record.add_run('ประกาศสำนักงานส่งเสริมเศรษฐกิจดิจิทัล').font
                font1.size = Pt(18)
                font1.bold = True
                one_record.add_run('')
                ...
                font = three_record.add_run('ฉบับที่ ').font
                font.size = Pt(18)
                font.bold = True
                if len_real_name == '13':
                    font1 = three_record.add_run(real_name[7]).font
                    font1.size = Pt(18)
                    font1.bold = True
                if len_real_name == '14':
                    font1 = three_record.add_run(real_name[7:9]).font
                    font1.size = Pt(18)
                    font1.bold = True
                if len_real_name == '15':
                    font1 = three_record.add_run(real_name[7:10]).font
                    font1.size = Pt(18)
                    font1.bold = True
                if len_real_name == '16':
                    font1 = three_record.add_run(real_name[7:11]).font
                    font1.size = Pt(18)
                    font1.bold = True
                if len_real_name == '17':
                    font1 = three_record.add_run(real_name[7:12]).font
                    font1.size = Pt(18)
                    font1.bold = True
                ...
                six_record.paragraph_format.line_spacing_rule = WD_LINE_SPACING.SINGLE
                six_record.paragraph_format.space_after = Pt(0)
                six_record.paragraph_format.space_before = Pt(12)
                ...
                seven_record.paragraph_format.space_before = Pt(0)
                ...
                eight_record.paragraph_format.left_indent = Inches(2.755906)
            ...
            if doc_ids.document_type == 'คำสั่ง ก' or doc_ids.document_type == 'คำสั่ง ข' or \
                ...
                if len_real_name == '19':
                    font2 = two_record.add_run(real_name[9:15]).font
                    font2.size = Pt(18)
                    font2.bold = True
                    font3 = two_record.add_run('(').font
                    font3.size = Pt(18)
                    font3.bold = True
                    font4 = two_record.add_run(real_name[15:19]).font
                    font4.size = Pt(18)
                    font4.bold = True
                    font5 = two_record.add_run(')').font
                    font5.size = Pt(18)
                    font5.bold = True
                ...
                six_record2.paragraph_format.space_before = Pt(0)

                edit_record4 = document.add_paragraph('')
                edit_record4.add_run('')
                edit_record4.paragraph_format.line_spacing_rule = WD_LINE_SPACING.SINGLE
                edit_record4.paragraph_format.space_after = Pt(0)
                edit_record4.paragraph_format.space_before = Pt(12)
            ...
            if doc_ids.document_type == 'หนังสือภายนอก+หนังสือรับรอง':
                ...
                zero_record = document.add_paragraph('')
                font5 = zero_record.add_run(speed).font
                font5.size = Pt(20)
                font5.bold = True
                font5.color.rgb = RGBColor(255, 0, 0)
                zero_record.paragraph_format.line_spacing_rule = WD_LINE_SPACING.SINGLE
                zero_record.paragraph_format.space_after = Pt(0)
                ...
                two_record = document.add_paragraph('เรื่อง  ')
                ...
                if len(receipt_group) > 0:
                    ...
                    four_record.add_run(
                        self.to_thai_number(str(self.year_convert2(receipt_group[0].date_document_real))))
                    four_record.paragraph_format.line_spacing_rule = WD_LINE_SPACING.SINGLE
                    four_record.paragraph_format.space_after = Pt(0)
                    ...
                    if len(receipt_group) > 1:
                        ...
                        four_record1.add_run(
                            self.to_thai_number(str(self.year_convert2(receipt_group[1].date_document_real))))
                        ...
                        if len(receipt_group) > 2:
                            ...
                            four_record2.add_run(
                                self.to_thai_number(str(self.year_convert2(receipt_group[2].date_document_real))))
                            ...
                            if len(receipt_group) > 3:
                                ...
                                four_record3.add_run(
                                    self.to_thai_number(str(self.year_convert2(receipt_group[3].date_document_real))))
                ...
                five_record = document.add_paragraph('สิ่งที่ส่งมาด้วย  ')
                if len(attached_file_in) > 0:
                    five_record.add_run(self.to_thai_number(str(attached_file_in[0].name)))
                    if len(attached_file_in) > 1:
                        five_record1 = document.add_paragraph('                  ')
                        five_record1.add_run(self.to_thai_number(str(attached_file_in[1].name)))
                ...
                seven_record2.paragraph_format.space_before = Pt(12)
                ...
                eight_record.paragraph_format.space_after = Pt(0)
                eight_record.paragraph_format.space_before = Pt(0)
                eight_record.paragraph_format.left_indent = Inches(2.598425)
                ...
                nine_record = document.add_paragraph('ส่วน ')
