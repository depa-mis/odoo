...
class AccountInvoice(models.Model):
    ...
    def fields_view_get(self, view_id=None, view_type='form',
        ...
        hide_reports_vendor = [
            'bione_account_form.bione_credit_note_tax_invoice_form_pdf_report',
            'bione_account_form.bione_debit_note_tax_invoice_form_pdf_report',
            'bione_account_form.bione_delivery_order_form_pdf_report',
            'bione_account_form.bione_delivery_order_tax_invoice_A_form_pdf_report',
            'bione_account_form.bione_delivery_order_tax_invoice_B_form_pdf_report',
        ]
