...
class fin_100_request_wiz_item(models.TransientModel):
    _name = 'fin_100_request_wiz_item'

    '''
    fields
    '''
    wiz_id = fields.Many2one('fin_100_request_wiz',string=_("Wizard request"))  
    ...
    wiz_id_all = fields.Many2one('fin_100_request_wiz',string=_("Purchase request"))   